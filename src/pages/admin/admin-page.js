...
function AdminPage() {
  ...
  const onAddTariffClicked = () => {
    setIsAddTariffOpen(true);
  };
  ...
  return (
    <div>
      ...
      {!isAddTariffOpen && (
        <button className="btn-add" onClick={onAddTariffClicked}>
          Add tariff
        </button>
      )}
      {isAddTariffOpen && <TariffForm setIsOpen={setIsAddTariffOpen} />}
