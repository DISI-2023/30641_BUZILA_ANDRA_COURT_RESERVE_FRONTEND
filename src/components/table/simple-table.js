...
function SimpleTable(props) {
    ...
    } = useTable({ columns, data, initialState: { pageIndex: 0 }}, usePagination, useResizeColumns, useBlockLayout,);


    return (
        <div>
            <br />
            <Table bordered hover responsive {...getTableProps()} style={{overflowX: "scroll", textAlign: "center", maxWidth: "50%",
            ...
            <div style={{textAlign: "center"}}>
                ...
                <span>
                    ...
                    <input type="number" defaultValue={pageIndex + 1} min={1} max={pageOptions.length}
                           onChange={e => {const page = e.target.value ? Number(e.target.value) - 1 : 0; gotoPage(page);}}
                           style={{ width: "100px" }}/>
                </span>
                {" "}
