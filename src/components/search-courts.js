...
function SearchCourts({searchFunction}){
    ...
    return(
        <div style={{display: "flex", justifyContent: "center", margin: "1% 0 1% 0"}}>
            <Input type="search" placeholder="...type location id" defaultValue={locationId}
            ...
            <TimePicker value={time} onChange={setTime}
                        style={{alignSelf: "center", margin: "0 1% 0 1%"}} />
            <Button type="submit" color="primary" onClick={submitSearch}
                    style={{alignSelf: "center", margin: "0 1% 0 1%"}}>
                Search
            </Button>
        </div>
